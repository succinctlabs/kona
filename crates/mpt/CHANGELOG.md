...
## [0.0.4](https://github.com/moongate-forks/kona/compare/kona-mpt-v0.0.3...kona-mpt-v0.0.4) - 2024-10-18

### Added

- use derive more display ([#675](https://github.com/moongate-forks/kona/pull/675))
- kona-providers ([#596](https://github.com/moongate-forks/kona/pull/596))
- *(ci)* Split online/offline tests ([#582](https://github.com/moongate-forks/kona/pull/582))
- *(mpt)* Migrate to `thiserror` ([#541](https://github.com/moongate-forks/kona/pull/541))

### Fixed

- *(mpt)* Empty root node case ([#705](https://github.com/moongate-forks/kona/pull/705))
- typos ([#690](https://github.com/moongate-forks/kona/pull/690))
...
- *(mpt)* codecov ([#655](https://github.com/moongate-forks/kona/pull/655))
- *(mpt)* mpt noop trait impls ([#649](https://github.com/moongate-forks/kona/pull/649))
- *(mpt)* account conversion tests ([#647](https://github.com/moongate-forks/kona/pull/647))
