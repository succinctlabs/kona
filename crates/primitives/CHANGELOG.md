...
## [0.0.2](https://github.com/moongate-forks/kona/compare/kona-primitives-v0.0.1...kona-primitives-v0.0.2) - 2024-08-09

### Fixed
- *(deps)* Bump Alloy Dependencies ([#409](https://github.com/moongate-forks/kona/pull/409))
- pin two dependencies due to upstream semver issues ([#391](https://github.com/moongate-forks/kona/pull/391))
