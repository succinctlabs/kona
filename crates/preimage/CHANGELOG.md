...
## [0.0.3](https://github.com/moongate-forks/kona/compare/kona-preimage-v0.0.2...kona-preimage-v0.0.3) - 2024-07-24

### Added
- *(client)* providers generic over oracles ([#336](https://github.com/moongate-forks/kona/pull/336))

### Other
- *(preimage)* Remove dynamic dispatch ([#354](https://github.com/moongate-forks/kona/pull/354))
