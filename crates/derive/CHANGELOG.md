...
## [0.0.3](https://github.com/moongate-forks/kona/compare/kona-derive-v0.0.2...kona-derive-v0.0.3) - 2024-08-09

### Added
- *(derive+trusted-sync)* online blob provider with fallback ([#410](https://github.com/moongate-forks/kona/pull/410))
...
### Fixed
- remove data iter option ([#405](https://github.com/moongate-forks/kona/pull/405))
- *(deps)* Bump Alloy Dependencies ([#409](https://github.com/moongate-forks/kona/pull/409))
- *(kona-derive)* Remove SignedRecoverable Shim ([#400](https://github.com/moongate-forks/kona/pull/400))
