...
## [0.0.4](https://github.com/moongate-forks/kona/compare/kona-derive-v0.0.3...kona-derive-v0.0.4) - 2024-10-18

### Added

- *(derive)* Add `ChannelAssembler` size limitation ([#700](https://github.com/moongate-forks/kona/pull/700))
- *(derive)* signal receiver logic ([#696](https://github.com/moongate-forks/kona/pull/696))
- *(derive)* Stage multiplexer ([#693](https://github.com/moongate-forks/kona/pull/693))
- *(derive)* `Past` batch validity variant ([#684](https://github.com/moongate-forks/kona/pull/684))
- codecov sources ([#657](https://github.com/moongate-forks/kona/pull/657))
- frame queue tests ([#613](https://github.com/moongate-forks/kona/pull/613))
- *(derive)* Holocene flush signal ([#612](https://github.com/moongate-forks/kona/pull/612))
- *(derive)* Add `Signal` API ([#611](https://github.com/moongate-forks/kona/pull/611))
- *(derive)* BatchQueue Update [Holocene] ([#601](https://github.com/moongate-forks/kona/pull/601))
...
- *(derive)* `BatchStream` buffering ([#590](https://github.com/moongate-forks/kona/pull/590))
- *(derive)* BatchStreamProvider ([#591](https://github.com/moongate-forks/kona/pull/591))
- *(derive)* Refactor out Online Providers ([#569](https://github.com/moongate-forks/kona/pull/569))
- *(derive)* interleaved channel tests ([#585](https://github.com/moongate-forks/kona/pull/585))
- *(derive)* Holocene Buffer Flushing ([#575](https://github.com/moongate-forks/kona/pull/575))
- *(derive)* Holocene Channel Bank Checks ([#572](https://github.com/moongate-forks/kona/pull/572))
- *(derive)* Holocene Frame Queue ([#579](https://github.com/moongate-forks/kona/pull/579))
- *(derive)* Holocene Activation ([#574](https://github.com/moongate-forks/kona/pull/574))
- *(derive)* wire up the batch span stage ([#567](https://github.com/moongate-forks/kona/pull/567))
- *(derive)* New BatchStream Stage for Holocene ([#566](https://github.com/moongate-forks/kona/pull/566))
- *(derive)* Hoist AttributesBuilder ([#571](https://github.com/moongate-forks/kona/pull/571))
- *(derive)* Touchup Docs ([#555](https://github.com/moongate-forks/kona/pull/555))
- *(derive)* Latest BN ([#521](https://github.com/moongate-forks/kona/pull/521))
...
- *(derive)* SpanBatch element limit + channel RLP size limit ([#692](https://github.com/moongate-forks/kona/pull/692))
- *(derive)* Holocene `SpanBatch` prefix checks ([#688](https://github.com/moongate-forks/kona/pull/688))
- *(derive)* Retain L1 blocks ([#683](https://github.com/moongate-forks/kona/pull/683))
- *(executor)* Holocene EIP-1559 params in Header ([#622](https://github.com/moongate-forks/kona/pull/622))
- derive pipeline params ([#587](https://github.com/moongate-forks/kona/pull/587))
- *(workspace)* hoist and fix lints ([#577](https://github.com/moongate-forks/kona/pull/577))
- *(derive)* move attributes builder trait ([#570](https://github.com/moongate-forks/kona/pull/570))
- *(client)* Channel reader error handling ([#539](https://github.com/moongate-forks/kona/pull/539))
- *(derive)* Sequence window expiry ([#532](https://github.com/moongate-forks/kona/pull/532))
...
- *(derive)* Add tracing to `ChannelAssembler` ([#701](https://github.com/moongate-forks/kona/pull/701))
- *(derive)* remove span batch todo comments ([#682](https://github.com/moongate-forks/kona/pull/682))
- refactor test utils ([#677](https://github.com/moongate-forks/kona/pull/677))
- *(derive)* stage coverage ([#673](https://github.com/moongate-forks/kona/pull/673))
- *(executor)* Use Upstreamed op-alloy Methods  ([#651](https://github.com/moongate-forks/kona/pull/651))
- *(derive)* Test and Clean Batch Types ([#670](https://github.com/moongate-forks/kona/pull/670))
- *(derive)* Test Stage Resets and Flushes ([#669](https://github.com/moongate-forks/kona/pull/669))
- *(derive)* Batch Timestamp Tests ([#664](https://github.com/moongate-forks/kona/pull/664))
- *(derive)* test channel reader flushing ([#661](https://github.com/moongate-forks/kona/pull/661))
- *(derive)* adds more channel bank coverage ([#659](https://github.com/moongate-forks/kona/pull/659))
- *(derive)* test channel reader resets ([#660](https://github.com/moongate-forks/kona/pull/660))
- *(derive)* test channel bank reset ([#658](https://github.com/moongate-forks/kona/pull/658))
- *(derive)* hoist attributes queue test utils ([#654](https://github.com/moongate-forks/kona/pull/654))
- *(derive)* Pipeline Core Test Coverage ([#642](https://github.com/moongate-forks/kona/pull/642))
- *(derive)* Single Batch Test Coverage ([#643](https://github.com/moongate-forks/kona/pull/643))
- *(derive)* Blob Source Test Coverage ([#631](https://github.com/moongate-forks/kona/pull/631))
...
- use alloy primitives map ([#586](https://github.com/moongate-forks/kona/pull/586))
- *(derive)* [Holocene] Drain previous channel in one iteration ([#583](https://github.com/moongate-forks/kona/pull/583))
- channel reader docs ([#568](https://github.com/moongate-forks/kona/pull/568))
