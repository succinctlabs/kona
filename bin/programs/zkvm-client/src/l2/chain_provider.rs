...
//         // On L1, trie node preimages are stored as keccak preimage types in the oracle. We
// assume         // that a hint for these preimages has already been sent, prior to this call.
...
//             assert_eq!(keccak256(&preimage), key, "L2 trie_node_preimage - zkvm constraint
// failed");
...
//                 // ZKVM Constraint: keccak(node preimage) = hash
//                 assert_eq!(keccak256(&bytecode), hash, "L2 bytecode_by_hash - zkvm constraint
// failed");
...
//             assert_eq!(keccak256(&header_bytes), hash, "L2 header_by_hash - zkvm constraint
// failed");
