    ...
    async fn prefetch(&self, hint: &str) -> Result<()> {
        ...
        match hint_type {
            ...
            HintType::L2StateNode => {
                ...
                // TODO(clabby): Unfortunately, we rely on hash scheme geth's `debug_dbGet` to
                // retrieve the preimage. This is not ideal and should be replaced
                // with a more robust solution in the future.
